...
var (
	...
	HigressGatewayClass = env.RegisterStringVar("GATEWAY_CLASS", "higress.io/gateway-controller", "The system namespace of Higress").Get()

	HigressGatewayStatusLeader  = env.RegisterStringVar("HIGRESS_GATEWAY_STATUS_LEADER", "higress-gateway-status-leader", "The system namespace of Higress").Get()
	GatewayDeploymentController = env.RegisterStringVar("HIGRESS_GATEWAY_DEPLOYMENT_LEADER", "higress-gateway-deployment-leader", "The system namespace of Higress").Get()
